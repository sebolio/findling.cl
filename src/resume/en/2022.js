export default {
    items: [{
            ...
            images: [
                ...
                { src: 'dreamoms4.jpg', alt: 'WhatsApp notifications' },
                { src: 'dreamoms5.jpg', alt: 'Location and embedding' },
                { src: 'dreamoms6.jpg', alt: 'Embedding shortcode' },
                { src: 'dreamoms7.jpg', alt: 'Settings' },
                { src: 'dreamoms8.jpg', alt: 'User roles' },
                { src: 'dreamoms2.jpg', alt: 'Embedded form' },
                { src: 'dreamoms9.jpg', alt: 'Happy team 💚' },
            ]
        },
        {
            title: '1n',
